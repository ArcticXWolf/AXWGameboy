...
AXWGameboyLogo_dst = $8080
AXWGameboyLogo_length = (128 * 24) / 64

LoadTileset:
    ld hl, AXWGameboyLogo
    ld de, AXWGameboyLogo_dst - 1
    ld c, AXWGameboyLogo_length
.refill
